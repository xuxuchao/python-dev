<template>
	<section>
		...
		<el-table :data="projects" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="项目名称"  style="width:20%;" sortable>
			</el-table-column>
			<el-table-column prop="description" label="描述"  style="width:40%;"  sortable>
			</el-table-column>
			<el-table-column prop="owner" label="创建者" style="width:20%;" sortable>
			</el-table-column>
...
<script>
	...
	import { getProjectListPage, removeProject, batchRemoveProject, editProject, addProject } from '../../api/api';
